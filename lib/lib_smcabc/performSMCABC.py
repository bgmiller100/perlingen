...
def main(N_parts, f_simulate, f_summaries, f_discrepancy, target_data, params_mins, params_maxs, scale_param, desired_D, mesh):
    ...
    while looping: 
        ...
        #print(np.shape(part_thetas[selection,:]))
        #print(worst_keep)
        #print(np.shape(part_thetas[worst_keep:,:]))
        #print(np.shape(part_thetas))
       ...
       # print('Complete\n')
        ...
        N_unique = np.shape(np.unique(int(part_thetas*(10**12)),axis=0))[0]
