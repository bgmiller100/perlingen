# -*- coding: utf-8 -*-
"""
Created on Fri Nov  1 10:10:28 2019
...
N_parts, desired_D):
    ...
    #scale_param = np.array([0, 0, 0, 0, 0, 0, 0, 0], dtype=int)
    scale_param = np.array([ 0, 0, 0, 0, 0, 0, 1, 0], dtype=int)
    # pg15: 'as the anisotropy is specified in terms of R, we transform it logarithmically 
    #desired_D = 0.5
    #visualise = 0 #show results
    
    print("running smcabc...\n")
    start_all = time.time()
    part_thetas, part_outputs, part_summaries, part_Ds = performSMCABC.main(N_parts, f_simulate, f_summaries, f_discrepancy, target_data, params_mins, params_maxs, scale_param, desired_D, mesh)
